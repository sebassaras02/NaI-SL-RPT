...
for i in range(len(x_des)):
    nombre ="pos"+ str(i+1) + ".mac" #paso el valor de la lista a cadena, me parece más legible
    archivo=open('C:/Universidad/PASANTIAS NUCLEAR/RPT_1D/macros_25/'+ nombre,'w') #fijate que a tu script le falta "/" después de c:
